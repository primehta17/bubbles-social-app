...
export default function PostInput() {
  return (
    ...
    <div className="flex space-x-5 p-3">
        <Image src={'/company-logo.jpg'} width={44} height={44} className="w-11 h-11" alt="comapny-logo"/>
        <div className='w-full'>
          ...
          <div className="flex justify-between">
              ...
              <button className="rounded-full bg-[#F4AF01] w-[80px] h-[36px] text-white text-sm corsor-pointer" >Facebook</button>
            </div>
        </div>
    </div>
