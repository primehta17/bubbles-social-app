...
function SidebarUserInfo() {
  ...
  return (
    <div className='absolute bottom-12 flex items-center justify-start space-x-2 hover:bg-gray-200 xl:pb-9 xl:pe-6 hover:bg-opacity-10 rounded-full transition cursor-pointer w-fit xl:w-[240px]'
